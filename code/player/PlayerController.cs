...
using TDD.player.movement.mechanics;
using System.Collections.Generic;
using System.Linq;
using TDD.player.mechanics.movement.platformer_holdovers;

namespace TDD.movement {
    partial class PlayerController : BasePlayerController {
        ...
        private List<BasePlayerMechanic> mechanics = new();
        private BasePlayerMechanic activeMechanic => mechanics.FirstOrDefault( x => x.IsActive );

        public IReadOnlyList<BasePlayerMechanic> Mechanics => mechanics;
        ...
        public T GetMechanic<T>() where T : BasePlayerMechanic {
        ...
        public override void Simulate() {
            ...
            // The player model's rotation
            if ( activeMechanic is null || !activeMechanic.TakesOverRotation ) {
            ...
            if ( control != null && ( control.TakesOverMovement || control.TakesOverRotation ) ) {
                control.Simulate();
            } else {
                foreach ( var m in mechanics ) {
                    if ( !m.IsActive && !m.AlwaysSimulate ) continue;
