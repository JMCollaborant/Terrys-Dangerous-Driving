...
namespace TDD.movement {
    partial class BasePlayerMechanic : BaseNetworkable {
        ...
        public virtual bool TakesOverMovement { get; }
        public virtual bool TakesOverRotation { get; }
        ...
        public BasePlayerMechanic( PlayerController controller ) {
            ctrl = controller;
        }
